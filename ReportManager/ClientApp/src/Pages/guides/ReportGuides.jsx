            ...
            <div className="report-form-box" style={{ display: 'flex' }}>
                ...
                <div style={{ flex: '3 1 75%' }}>
                    ...
                    <section id="setting-up-automated-tasks">
                        ...
                        <p>In a business production enviornment, the tool is designed to be scaled to include permissions management, including both the report files and folders themselves.
